...
var app = (0, app_1.buildApp)();
var server = app.listen(env_1.env.PORT, function () {
    console.log("\n\uD83D\uDE80 API ready: http://localhost:".concat(env_1.env.PORT, "/api"));
    console.log("   Health:  http://localhost:".concat(env_1.env.PORT, "/api/health"));
    console.log("   Env:     ".concat(env_1.env.NODE_ENV, "\n"));
});
/**
