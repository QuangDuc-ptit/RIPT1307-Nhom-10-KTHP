...
const ProfilePage: React.FC = () => {
  ...
  if (!currentUser) return <div style={{ minHeight: '100vh', backgroundColor: colors.bgApp, color: colors.textMain, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>Đang tải thông tin...</div>;

  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: colors.bgApp, color: colors.textMain }}>
      
      <ProfileSidebar activeMenu={activeMenu} setActiveMenu={setActiveMenu} user={currentUser} />
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 40px', borderBottom: `1px solid ${colors.border}` }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <Avatar src={currentUser.avatar} style={{ backgroundColor: '#fcdfd5', color: colors.primary, fontWeight: 'bold', cursor: 'pointer' }}>
